...
const services = [
  ...
  },
  {
    ...
    description: "Scalable cloud infrastructure and migration services to power your business with AWS, Azure, and GCP.",
    icon: Cloud,
  ...
  {
    title: "Cybersecurity",
    description: "Protect your business with comprehensive security solutions and threat prevention measures.",
    icon: Shield,
  ...
  {
    title: "Consulting",
    description: "Expert guidance to align technology with your business goals and objectives.",
    icon: Briefcase,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-xl text-foreground/80 max-w-3xl mx-auto animate-fade-in" style={{animationDelay: '400ms'}}>
            We provide comprehensive IT solutions tailored to your business needs, helping you achieve digital excellence.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => (
            <div
              key={index}
              className={`group relative bg-card rounded-2xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl ${
            ...
            >
              ...
              <div className="flex items-start space-x-4">
                <div className={`text-4xl mb-4 transition-transform duration-300 group-hover:scale-110 ${index === activeService ? 'scale-110' : ''}`}>
  {(() => {
    ...
    return <Icon size={40} className="text-primary" />;
              ...
              {/* Hover effect */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-transparent via-transparent to-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
          ))}
        </div>
      ...
      {/* Decorative elements */}
      <div className="absolute top-0 left-10 w-20 h-20 bg-primary/10 rounded-full blur-xl animate-pulse"></div>
      <div className="absolute bottom-0 right-10 w-32 h-32 bg-accent/10 rounded-full blur-xl animate-pulse animation-delay-2000"></div>
    </section>
  );
}