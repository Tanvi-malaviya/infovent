  ...
  return (
    <footer className="relative bg-gradient-to-b from-secondary to-background border-t border-border">
      ...
      <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="py-12 sm:py-14 md:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/services/mobile-applications">Mobile Apps</Link></li>
              <li><Link href="/services/cloud-solutions">Cloud Solutions</Link></li>
              <li><Link href="/services/ai-machine-learning">AI & ML</Link></li>
        ...
        {/* Bottom */}
        <div className="border-t border-border/50 py-6 flex flex-col md:flex-row justify-between items-center">
          <p>© {year || '2026'} Infovent. All rights reserved.</p>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 w-11 h-11 rounded-full bg-primary text-white flex items-center justify-center"
      >
        ↑
      </button>
