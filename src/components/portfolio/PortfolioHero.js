...
export default function PortfolioHero() {
  ...
  // Start the background SVG animation on load
  useEffect(() => {
    controls.start({
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden px-6 py-24">
      
      {/* 1. UNIQUE BACKGROUND: Interconnected "Circuitry" SVG */}
      ...
      {/* 2. MAIN CONTENT LAYOUT: Asymmetrical Flow */}
  ...
  <div className="space-y-8 relative z-10">
    ...
    >
      We craft immersive digital experiences by merging creative vision
  ...
  <div className="relative flex justify-center items-center min-h-[500px]">
    ...
    {/* Glow */}
    <div className="absolute w-96 h-96 bg-primary/10 blur-[120px] rounded-full" />
    ...
    <div className="relative w-[420px] h-[420px]">
        ...
        return (
          ...
          >
            <motion.div
              ...
              className="w-full h-full rounded-full bg-card/40 backdrop-blur-2xl border border-primary/20 shadow-xl flex flex-col items-center justify-center p-5 text-center"
            >
              <div className="p-3 rounded-full bg-primary/10 border border-primary/20 mb-3">
      ...
      {/* Center Node */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-background border-2 border-primary">
